...
//-------------------------------------------------------------------
export function fire(props, component) {
    ...
    function render(props) {
        setTimeout(function () {
            var c = React.createElement(component, props, props.content);
    ...
    function update(configUpdate) {
        if (typeof configUpdate === 'function') {
            ...
            currentConfig = { ...props, ...configUpdate };
        }
        render(currentConfig);
    }
    if (props.stackFunc) {
        stack.push(props.stackFunc)
    }
    pushStateHistoryModal(setVisible, getStack);
    render(currentConfig);
    return {
        destroy: close,
        update: update
